...
const checkContentStatus = (req, res) => {
    ...
    if (!req.body.hasOwnProperty('contentStatus') && type == "contents") {
    ...
    let bulkStmt = "";
    if (type == "batchJob") {
        bulkStmt = "SELECT * FROM CONTENT_BULK_UPLOAD WHERE " + b;
        sqlStmt = `SELECT * FROM CONTENT_INFO WHERE ` + a;
...
const contentBatchStatusList = (req, res) => {
    let type = req.body.checkStatus;
    let query = [], bulkQuery = [];
    let userInfo, batchStatus = "completed", contentStatus, process_id, channel;
    ...
    let b = bulkQuery.join(" AND ");
    let sqlStmt = "";
    sqlStmt = "SELECT * FROM CONTENT_BULK_UPLOAD WHERE " + b;
...
const checkBroadcastContentStatus = (req, res) => {
    let type = req.body.checkStatus;
    let query = [], bulkQuery = [];
    let userInfo, batchStatus = "completed", contentStatus, process_id, channel;
    ...
    let bulkStmt = "";
    if (type == "batchJob") {
        bulkStmt = "SELECT * FROM BROADCAST_CONTENT_UPLOAD WHERE " + b;
        sqlStmt = `SELECT * FROM BROADCAST_CONTENT_INFO WHERE ` + a;
    } else if (type == "contents") {
        sqlStmt = `SELECT * FROM BROADCAST_CONTENT_INFO WHERE ` + a;
    }
...
const BroadcastcontentBatchStatusList = (req, res) => {
    let type = req.body.checkStatus;
    let query = [], bulkQuery = [];
    let userInfo, batchStatus = "completed", contentStatus, process_id, channel;
    ...
    let b = bulkQuery.join(" AND ");
    let sqlStmt = "";
    sqlStmt = "SELECT * FROM BROADCAST_CONTENT_UPLOAD WHERE " + b;
...
module.exports = { checkContentStatus, contentBatchStatusList, checkBroadcastContentStatus, BroadcastcontentBatchStatusList }