...
for pid in p_ids:
    ...
    with open("/home/tanweer/Downloads/school_preprod_success_orgg.json", 'a') as file1:
        json.dump(response1, file1)
    with open("/home/tanweer/Downloads/school_preprod_failed_orgg.json", 'a') as file2:
