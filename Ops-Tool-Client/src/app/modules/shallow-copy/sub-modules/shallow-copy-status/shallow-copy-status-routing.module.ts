...
const routes: Routes = [
  {
    path: NTPCONSTANTS.ROUTERLINKS.SHALLOW_COPY.UPLOAD_STATUS, component: ListComponent,
    data: {
      breadcrumb: [
        {
        ...
        {
          label: 'Upload Status',
          url: '/contents/shallow-copy/upload-status',
          active: true
        }
      ],
    },
...
export class ShallowCopyStatusRoutingModule { }
