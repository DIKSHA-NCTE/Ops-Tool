...
const routes: Routes = [
  {
    path: NTPCONSTANTS.ROUTERLINKS.USERS_BULK_UPLOAD.UPLOAD_STATUS, component: ListComponent,
    data: {
      breadcrumb: [
        {
        ...
        },
        {
          ...
          url: '/users/bulk-upload/upload-status',
          active: true
        }
      ],
    },
...
export class UserUploadStatusRoutingModule { }
