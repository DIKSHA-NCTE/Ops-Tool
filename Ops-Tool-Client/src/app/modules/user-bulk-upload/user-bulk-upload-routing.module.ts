...
const userBulkUpload: Routes = [
  {
    path: NTPCONSTANTS.ROUTERLINKS.USERS_BULK_UPLOAD.LIST, component: ListComponent,
    data: {
      breadcrumb: [
        {
...
@NgModule({
  imports: [RouterModule.forChild(userBulkUpload)],
  exports: [RouterModule]
})

export class UserBulkUploadRoutingModule { }
